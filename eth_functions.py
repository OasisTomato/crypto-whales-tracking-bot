...
# Function to query the Etherscan.io API to get the balance for a specific Tx, based on token contract address and
# Ethereum Address
def get_token_balance(address, contractaddress, tokenname, tokensymbol, time, tx_direction):
	...
	try:
		...
		if type(data) is None:
			print("Data Object None, something went wrong, Will try again")
		else:
